						...
						<div class="row invoice-table">
							<div class="col-md-12">
									...
									<tbody>
										<?php
											...
											for($i = 0;$i < $length;$i++) {
												...
												$total_after_discount	= $total_item*$price_after_discount;
										?>
										...
										<tr>
											...
											<td><?php echo $currency.' '.$total_after_discount;?></td>
										</tr>
										
										<?php 
												$subtotal	= $subtotal+$total_after_discount;
											}
										?>
								...
								<table class="itemTotal" border="0">
									...
									<tr><td>Delivery Cost</td><td><?php if(strtolower($location) == 'dhaka'){$dcharge = 50;} else {$dcharge = 100;} echo $currency.' '.$dcharge ?></td></tr>
