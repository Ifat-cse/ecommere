								...
								<div class="my-div">
									...
									<div id="q-product-details" >
										...
										<div class="form-group">
											...
											<div class="checkbox-inline"><label class="ava-size"><input type="checkbox" name="size[]" value="XXL" id="checkboxXXL"> 35.5</label></div>
                                            <div class="checkbox-inline"><label class="ava-size"><input type="checkbox" name="size[]" value="XXL" id="checkboxXXL"> 37</label></div>
                                            <div class="checkbox-inline"><label class="ava-size"><input type="checkbox" name="size[]" value="XXL" id="checkboxXXL"> 38</label></div>
                                            <div class="checkbox-inline"><label class="ava-size"><input type="checkbox" name="size[]" value="XXL" id="checkboxXXL"> 39</label></div>
										</div>
