...
<?php 
	if(isset($_POST['add'])) {
		...
		$fields['username']		= mysqli_real_escape_string($conn_pr, $_POST['username']);
		$fields['password']		= mysqli_real_escape_string($conn_pr, $_POST['password']);
	...
	if(isset($_POST['update'])) {
		$id						= mysqli_real_escape_string($conn_pr, $_POST['id']);
		$fields['username']		= mysqli_real_escape_string($conn_pr, $_POST['username']);
		$fields['password']		= mysqli_real_escape_string($conn_pr, $_POST['password']);
	...
	if(isset($_GET['delete'])) {
		$id		= mysqli_real_escape_string($conn_pr, $_GET['id']);
