...
<body class="dashboard-page">
	<?php
		...
		$check 		= "SELECT * FROM admins where Token = '".$token."'";
		$list		= $conn->query($check);
		
		if($list->num_rows  == 1) {
			$list_row	= $list->fetch_array();
	...
	<nav class="main-menu">
		<ul>
			...
			<li>
				<a href="#">
					<i class="fa fa-bar-chart-o nav_icon"></i>
					<span class="nav-text">Sales Report </span>
					<i class="icon-angle-right"></i><i class="icon-angle-down"></i>
				</a>
				<ul>
					<li><a class="subnav-text" href="report-date-wise.php">Date Wise</a></li>
					<li><a class="subnav-text" href="report-product-wise.php">Product Wise</a></li>
				</ul>
			</li>
			<li>
				<a href="mailbox.php">
			...
			<li>
				...
				<ul>
					...
					<li><a class="subnav-text" href="banners.php">Banners</a></li>
				</ul>
			</li>
			<li>
