...
<?php
	//BRAND FILTER 
	if(!empty($brand)) {
		$sor = "AND brand = '{".addslashes($brand)."' ";
	} else {
		$sor = "";
	}
?>
...
<?php	
	...
	switch( $sort ) {
		...
		case 11:
			...
			break;
		case 12:
			$sortvalue			= isset($_GET['range']) ? $_GET['range']: "0,10000";
...
<?php
	$result_products 		= get_search_products($search, $main, $sor, 15, $offset1);
	$result_total_products 	= get_search_products($search, $main, $sor, 9999999999, 0);
			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="liftsideimg">
						<img src="images/shop/happynewyear.png">
					</div>
					
					<div class="liftsideimg">
						<img src="images/shop/summer.png">
					</div>
				</div>
					...
					<div class="features_items">						
						<div class="row hr">
							<div class="">
								<div class="col-md-7">
									<ul class="pajeurl">
										<li><strong>Search: </strong> <?php echo $search; ?></li>
									</ul>
								</div>
								<div class="col-md-5">
							...
							<div class="col-sm-4">
								<div class="ul-center">
									<div class="bottom-sorter">
										<label class="bottom-sorter-label" for="sorter">Sho Per Page</label>
